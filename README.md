...
but using a browser to display it doesn't let you do that. I wrote a little
script that uses the Qt WebKit widgets to display two instances of your slides
at once.
